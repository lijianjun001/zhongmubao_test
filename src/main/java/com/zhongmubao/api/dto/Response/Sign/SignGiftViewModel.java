...
public class SignGiftViewModel {
    ...
    public SignGiftViewModel(String id, String title, String type, int count, String unit, SignGiftRedPackageViewModel signGiftRedPackage, SignGiftAddressViewModel signGiftAddress) {
        this.id = id;
        this.type = type;
        this.count = count;
