...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket createRestApi() {
        ...
        tokenPar.name("platform").description("平台").modelRef(new ModelRef("string")).parameterType("header").required(false).build();
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build().globalOperationParameters(pars).enable(false);
    }
